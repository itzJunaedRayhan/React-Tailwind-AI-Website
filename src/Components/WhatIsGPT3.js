...
const WhatIsGPT3 = () => {
    return (
        <div className='GPT3 xs:w-11/12 xs:px-1 lg:container min-h-[80vh] mx-auto bg-ternary px-4 py-10 shadow-lg my-6'>
            <div className='xs:grid-cols-1 xs:px-2 md:grid-cols-3 md:px-3 lg:px-6 xl:px-8 px-8 grid grid-cols-3'>
                <div className='xs:pb-4 md:pb-0'>
                    <h2 className="relative text-heaven font-bold text-2xl before:absolute before:content-[''] before:w-24 before:h-[3px] before:-top-2 before:rounded-sm before:bg-[#AE67FA]">What is GPT-3</h2>
                </div>
                <div className='col-span-2'>
                    <p className='xs:text-sm xs:leading-normal xs:text-justify lg:leading-6 text-[#81AFDD] leading-6 font-medium text-[16px]'>We so opinion friends me message as delight. Whole front do of plate heard oh ought. His defective nor convinced residence own. Connection has put impossible own apartments boisterous. At jointure ladyship insisted so humanity he. Friendly bachelor entrance to on by.</p>
                </div>
            </div>

            <div className='xs:grid-cols-1 xs:px-2 md:grid-cols-2 md:px-3 lg:px-6 xl:px-8 px-8 grid grid-cols-2 py-[8%]'>
                <h2 className='xs:text-2xl md:text-2xl lg:text-3xl max-w-[400px] text-[#AE67FA] text-3xl font-bold'>The possibilities are beyond your imagination</h2>
                <p className='xs:text-left xs:py-3 xs:pl-1 md:py-0 md:text-right text-right text-[#FF8A71] text-sm font-medium'>Explore The Library</p>
            </div>
